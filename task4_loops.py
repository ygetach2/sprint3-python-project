...
JP_SALES = 8
GLOBAL_SALES = 9
# create loop for games with more than 25 million global sales

for game in video_game_sales:
    if game[GLOBAL_SALES] > 25:
        print(game[NAME], "-", game[GLOBAL_SALES], "million")

# write a loop that Count games released before 2000
...
# calculate North America sales and Japan sales total
total_na_sales = 0
total_jp_sales = 0
...
# Create a list of Nintendo games    
